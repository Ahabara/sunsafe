                ...
                <div className="flex flex-col lg:flex-row justify-between gap-8">
                    <div className="w-full lg:w-5/12 flex flex-col justify-center">
                        <h1 className="text-3xl lg:text-4xl font-bold leading-9 text-gray-800 dark:text-white pb-4">About
                            Us</h1>
                        <p className="font-normal text-base leading-6 text-gray-600 dark:text-white">At SunSmart, we are
                        ...
                        <p>At the core of our mission is a dedication to empowering individuals to make informed
                            ...
                            meticulous research and development, we have crafted SunSafeNow to be a comprehensive
                            resource for users seeking to enhance their sun safety practices.

                        </p>
                    </div>
                    <div className="w-full lg:w-8/12">
                        <img className="w-full h-full" src={TeamPhoto}
                    ...
                    <div className="w-full lg:w-8/12 lg:pt-8">
                        <div className="grid md:grid-cols-4 sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-md">
                            <div className="p-4 pb-6 flex justify-center flex-col items-center">
                                <img className="md:block hidden w-32 max-h-32" src={abdel}
                                     alt="Olivia featured Image"/>
                                <img className="md:hidden block" src={abdel}
                                     alt="Olivia featured Image"/>
                                <p className="font-medium text-xl leading-5 text-gray-800 dark:text-white mt-4">Erman</p>
                            </div>
                            <div className="p-4 pb-6 flex justify-center flex-col items-center">
                                <img className="md:block hidden w-32 max-h-32" src={erman}
                                     alt="Olivia featured Image"/>
                                <img className="md:hidden block" src={erman}
                                     alt="Olivia featured Image"/>
                                <p className="font-medium text-xl leading-5 text-gray-800 dark:text-white mt-4">Erman</p>
                            </div>
                            <div className="p-4 pb-6 flex justify-center flex-col items-center">
                                ...
                                <img className="md:hidden block" src={minghzi}
                                     alt="Liam featued Image"/>
                            ...
                            <div className="p-4 pb-6 flex justify-center flex-col items-center">
                                ...
                                <img className="md:hidden block" src={aneri}
                                     alt="Elijah featured image"/>
