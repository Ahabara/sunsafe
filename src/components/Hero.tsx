        ...
        <section className="bg-white dark:bg-gray-900 pb-12">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Lorem
                        ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse egestas eros vitae egestas
                        blandit. Curabitur vitae lacus tortor. Quisque finibus, mi vel mattis accumsan, ante metus
                        suscipit lacus, porta interdum.</p>
                    <a href="#mainapp"
